...
const PREFECTURES = {
  ...
  "16": { name: "富山県", kana: "とやまけん", capital: "富山", capitalKana: "とやま", region: "chubu", info: "まわりを 高い（たかい）山（やま）にかこまれていて、きれいで 冷たい（つめたい）水（みず）が ながれているよ。「ホタルイカ」や、くすりの まちとして 有名（ゆうめい）だよ。" },
